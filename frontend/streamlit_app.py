...
with col2:
    ...
    if st.button("Abrir", key="fatur", width="stretch", type="primary"):
...
with col3:
    ...
    if st.button("Abrir", key="aloc", width="stretch", type="primary"):
...
with col4:
    ...
    if st.button("Abrir", key="revisor", width="stretch", type="primary"):
...
with col6:
    ...
    if st.button("Abrir", key="docfill", width="stretch", type="primary"):
